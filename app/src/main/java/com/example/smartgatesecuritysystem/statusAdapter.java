 ...
 */
public class statusAdapter extends RecyclerView.Adapter<statusAdapter.ViewHolders> {
    ...
    public statusAdapter(SecurityRequests securityRequests, ArrayList<String> visitor_name, ArrayList<String> status, ArrayList<String> id) {
